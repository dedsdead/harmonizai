...
- [ ] CHK001 Is it explicitly stated which API endpoints must remain byte-identical after migration? [Completeness]
...
- [ ] CHK004 Is there a specification for how CORS preflight (`OPTIONS`) responses should behave after migration? [Completeness]
